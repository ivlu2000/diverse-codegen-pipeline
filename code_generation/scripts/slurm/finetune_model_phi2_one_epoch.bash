...
NUM_SAMPLES=${1:-5000}  # Default to 5000 if not provided
...
export OUTPUT_MODEL_PATH="code_generation/models/phi2-finetuned-${DATASET_NAME}"
bash code_generation/scripts/instruction_tuning/finetune_phi2_one_epoch.sh
